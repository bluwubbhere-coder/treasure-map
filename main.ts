...
sprites.onOverlap(SpriteKind.Player, SpriteKind.helper, function (sprite, otherSprite) {
    game.showLongText("Press A to interact!", DialogLayout.Top)
})
...
function transition1 () {
    ...
    game.showLongText("Coordinates: 0, 0", DialogLayout.Top)
    ...
    mySprite5 = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.helper)
    tiles.placeOnTile(mySprite5, tiles.getTileLocation(3, 5))
